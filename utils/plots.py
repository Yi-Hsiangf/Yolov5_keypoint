...
class Annotator:
    ...
    def box_label(self, box, key_x, key_y, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                self.draw.point((key_x,key_y), fill=color)
        else:  # cv2
            #print("cv2")
            ...
            if label:
                ...
                cv2.circle(self.im, (int(key_x), int(key_y)), 1, color, 4)
